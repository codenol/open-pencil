...
export const panelMessageDefaults = {
  ...
  rulesAdd: 'Add rules',
  rulesBlockEmpty: 'Empty',
  rulesStepsHint: 'One item per line. Markdown is supported.',
  rulesTextHint: 'Markdown is supported.',
  rulesHere: 'Rules belong to the component and are saved with the document.',
  rulesPurpose: 'Description',
  rulesHowto: 'How to assemble',
  rulesUse: 'When to use',
  rulesAvoid: 'When not to use',
  rulesAllowed: 'What may be changed',
  rulesForbidden: 'What must not be changed',
  rulesChecks: 'Checks before finishing',
  assets: 'Assets',
  ...
  loading: 'Loading…',
  cancel: 'Cancel',
  localLibraries: 'Local assets',
  storageLibraries: 'Library',
  storageNotConfigured: 'Storage is not configured',
  storageLibrariesUnavailable: 'Library mode is not available yet',
