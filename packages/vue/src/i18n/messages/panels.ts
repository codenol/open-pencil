...
export const panelMessageDefaults = {
  ...
  matchDescription:
    'Components that came from other libraries. Link a copy to its master so updates from the source reach this file.',
  matchFilterUnlinked: params('Without a pair ({count})'),
  matchFilterAll: params('All ({count})'),
  matchEmptyUnlinked: 'All copies are linked — nice.',
  matchEmptyAll: 'No library copies found in this file.',
  matchSet: 'set',
  matchInstances: params('{count} instances'),
  matchSourceExternal: 'source: library',
  matchSourceOrigin: 'origin:',
  matchLinked: 'linked',
  matchChooseMaster: 'Choose a master…',
  matchSearch: 'Search components…',
  matchNoCandidates: 'No components available',
  matchLimitHint: params('Showing first {limit}. Narrow the list with filters.'),
  ...
  updateSelectedCount: params('Update selected ({count})'),
  openLibrarySource: 'Open',
  removeLibrary: 'Remove library',
  confirmRemoveLibrary: 'Remove?',
  ...
  docDescriptionHint: 'What this component is for',
  docGuidelines: 'How to use',
  docGuidelinesHint: 'When to use, what to combine with',
  docGuardrails: 'How not to use',
  docGuardrailsHint: 'What to avoid, common mistakes',
  goToMainComponent: 'Go to Main Component',
  detachInstance: 'Detach Instance',
  replaceComponent: 'Replace component',
  replaceComponentPlaceholder: 'Choose a component…',
  replaceComponentSearch: 'Search components…',
  replaceComponentEmpty: 'No components found',
