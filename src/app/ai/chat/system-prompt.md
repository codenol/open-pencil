...
- You can add content inside an instance. Its children are editable: new nodes become overrides, the link to the component stays, and overrides survive a component update. This is the normal way to fill a layout that comes as an instance — put a dashboard, a table or a form into its empty container rather than rebuilding the frame. Do not spend a render to test this: it works.
