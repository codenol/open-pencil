...
import { useAssistantTimer } from '@/app/ai/chat/busy'
 ...
 */
// Время считает общее хранилище: панель чата пересоздаётся при смене
// разговора, и счётчик, живущий здесь, терялся вместе с ней.
const { elapsedMs } = useAssistantTimer()
